    ...
    */
    ...
    return (
      ...
      <View style={{flex: 1}}>
          ...
          <View>
            <TouchableOpacity onPress={() => NavigationManager.navigate("SwipingPage", {ourrealm: this.state.ourrealm})}>
          ...
          <View>
            <TouchableOpacity onPress={() => NavigationManager.navigate("JioPage", {ourrealm: this.state.ourrealm})}>
                <Image resizeMode="cover"
